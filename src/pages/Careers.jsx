...
import BlogsHeroImg from '/src/assets/About/step1.png'; // Adjust the path as necessary
import ServicesImg from '/src/assets/Services/step2.png'; // Adjust the path as
