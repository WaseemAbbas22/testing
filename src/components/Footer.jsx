    ...
    <footer className="bg-darkgreen text-white w-full flex flex-col justify-between">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between mt-6 md:mt-12 mb-6 gap-4 md:gap-8 px-2">
        ...
        <div className="md:max-w-xs">
          <img src={LogoWhite} alt="Accurate Logo" className="w-20 sm:w-24 md:w-28 lg:w-32 h-auto mx-auto md:mx-0" />
          <p className="
        ...
        <div className="flex-1 flex flex-col-3 md:flex-row justify-between gap-4 text-center md:text-left">
          ...
          {/* Combined Container */}
          <div className="flex flex-row sm:flex-row justify-between w-full md:w-1/2 mx-auto gap-4">
          ...
          <div className="text-[8px] sm:text-[10px] md:text-xs lg:text-sm flex flex-col gap-3 md:ml-6 md:mt-2">
            ...
            <div className="text-white mt-2">
              <div className="relative">
                <div className="absolute top-3 left-2.5 w-px h-[calc(80%-8px)] bg-white hidden sm:block"></div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-start relative">
                    ...
                    <span className="ml-1 md:ml-3 w-full sm:w-[266px] text-[8px] sm:text-[10px] md:text-[12px] lg:text-[13px] leading-relaxed pb-2 border-b justify-left border-white">
                  ...
                  <div className="flex items-start relative">
                    <div className="relative z-10">
                      <div className="bg-white rounded-full w-1 h-1 mt-1 ml-[3px]"></div>
                    </div>
                    <span className="ml-[4px] md:ml-5 text-[8px] sm:text-[10px] md:text-[12px] lg:text-[13px] leading-relaxed pb-2 border-b border-[#FFFFFF]">
                  ...
                  <div className="flex items-start relative">
                    ...
                    <span className="ml-[4px] md:ml-5 text-[8px] sm:text-[10px] md:text-[12px] lg:text-[13px] leading-relaxed">
