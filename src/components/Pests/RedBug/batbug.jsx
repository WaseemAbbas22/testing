...
const BatBug = () => {
  return (
    ...
    <PestInfoPage
      ...
      pestDescription={[
        { label: "", value: "Bites similar to those of bed bugs, especially near the upper body" },
        { label: "", value: "Presence of bugs near attics, ceiling lights, or vents" },
        { label: "", value: "Discovery of bat nesting sites in the structure" },
        { label: "", value: "Comparable to the bed bug life cycle stages" },
        { label: "", value: "Persistent bites despite bed bug treatments (a clue it's bat bugs)" },
        ]}
      ...
      habitat={[
        "Red, itchy welts and irritation",
        "Anxiety, stress, and sleep disruption",
        "Ongoing infestations of bat colonies are not removed",
