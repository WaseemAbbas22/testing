...
const RemoveAnimals = ({ heading, animals }) => {
  return (
    <div className="w-full flex flex-col items-center 3xl:py-14 bg-white">
      <h2 className="text-4xl font-bold mb-8 3xl:mb-12  text-center 3xl:text-[50px]">{heading}</h2>
      ...
      <div className="flex flex-wrap justify-center gap-4 w-4/5">
        {animals.map((animal, index) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 w-full text-white text-sm text-left 3xl:py-6 3xl:px-6">
              <div className="font-semibold text-sm sm:text-base 3xl:text-xl">{animal.name}</div>
