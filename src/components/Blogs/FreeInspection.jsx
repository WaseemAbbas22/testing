    ...
    >
      <div className="p-3 sm:p-4 md:p-6 lg:p-8 space-y-3 sm:space-y-4 bg-black bg-opacity-70 mb-2 rounded-lg">
        ...
        <input
          type="text"
          placeholder="Name"
          className="border text-xs sm:text-sm px-3 py-2 rounded w-[100%] text-black h-8 sm:h-9 md:h-10"
        />
        ...
        <button className="bg-[#32A849] text-white px-1 sm:px-2 md:px-4 py-1 sm:py-2 md:py-2 rounded w-full text-xs sm:text-sm md:text-xs">
          Send
        </button>
      </div>
    </div>
