...
const Branches = () => {
  return (
    <div className="w-full bg-white py-12 px-4 sm:px-6 md:px-16 lg:px-24 xl:px-32 flex flex-col items-center">
      {/* Heading */}
      ...
      {/* Boxes Grid */}
      <div className="flex flex-col items-center gap-10 sm:gap-10 md:gap-[24px]">
        {/* Upper Line with 4 Boxes */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-10 md:gap-[120px]">
          <div className="bg-[#F2F2F2] w-[200px] sm:w-[220px] h-[90px] flex items-center justify-center rounded-sm shadow-md border border-gray-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-10 md:gap-[50px]">
          <div className="bg-[#F2F2F2] w-[200px] sm:w-[250px] h-[100px] flex items-center justify-center rounded-sm shadow-md border border-gray-200">
