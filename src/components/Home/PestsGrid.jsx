...
const PestGrid = () => {
  return (
    <div className="w-full bg-bggray py-16 px-4 md:px-16 lg:px-32 2xl:px-48 text-center ">
      <h2 className="text-black/70 lg:text-5xl md:text-3xl font-bold mb-2 2xl:text-7xl 2xl:mt-8">Our Services</h2>
      ...
      <div className="2xl:w-[88%] lg:w-[95%] lg:ml-20 2xl:ml-32 grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-2 lg:gap-4 xl:gap-2 2xl:gap-8 justify-items-center justify-center">
      ...
      <button className="bg-green-600 text-white text-sm 2xl:text-2xl 2xl:mt-12 lg:mt-6 font-semibold px-6 py-2 rounded shadow hover:bg-green-700 transition">
        View More
      </button>
    </div>
  );
