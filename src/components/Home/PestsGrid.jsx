  ...
  return (
    <div className="w-full bg-bggray px-4 md:px-8 lg:px-12 2xl:px-24 3xl:px-36 4xl:px-48">
      <div className="flex flex-col items-center justify-center min-h-[80vh] py-6 md:py-16 text-center">
        {/* Heading */}
        <h2 className="text-black/70 text-2xl md:text-3xl lg:text-5xl 2xl:text-6xl 3xl:text-7xl font-bold">
          Our Services
        </h2>

        {/* Description */}
        <p className="text-black/60 text-sm md:text-base lg:text-lg 2xl:text-xl 3xl:text-2xl mt-2 mb-6 md:mb-8 lg:mb-8 2xl:mb-10 max-w-3xl">
        ...
        {/* View More Button */}
        <button className="bg-green-600 text-white text-sm 2xl:text-xl mt-6 2xl:mt-12 font-semibold px-6 py-2 md:px-6 md:py-2 rounded shadow hover:bg-green-700 transition">
          View More
        </button>
      </div>
    </div>
