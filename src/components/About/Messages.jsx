...
const Messages = () => {
  return (
    <div className="w-full font-sans">
      ...
      {/* CEO's Message */}
      <div className="w-full bg-gray-100 px-6 md:px-16 lg:px-24 xl:px-32 py-2 flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="md:w-1/2 flex flex-col justify-center">
          ...
          <p className="text-gray-700 mb-4 text-sm md:text-sm leading-snug text-justify">
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-gray-500 font-base">Chief Executive Officer (CEO)</p>
            <p className="text-base text-gray-600 font-bold">B.Sc. Hons. Agriculture</p>
      ...
      {/* MD's Message */}
      <div className="w-full px-6 md:px-16 lg:px-24 xl:px-32 py-8 flex flex-col md:flex-row-reverse items-center gap-6">
        ...
        <div className="md:w-1/2 flex flex-col justify-center">
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-sm text-gray-500 font-semibold">Managing Director (MD)</p>
            <p className="text-base text-gray-600 font-bold">Pharm.D / MBA Marketing</p>
          </div>
        </div>
